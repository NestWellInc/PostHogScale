# ProjectScale Factory — Canonical Master State

**Purpose:** This is the authoritative cross-chat control file for the automated money-making Factory. Update this file whenever research, pricing, offers, implementation status, blockers, or execution priorities materially change. Work/desktop sessions should read this file first and use it as the current source of truth rather than reconstructing state from chat history.

**Survival deadline:** September 6, 2026.

## Primary economic goal
Generate legitimate verified net cash sufficient to cover the owner's ongoing ChatGPT/AI operating cost and establish a recurring monthly AI-operations reserve. Do not assume the subscription amount unless verified or supplied by the owner.

## Cash accounting
- Count only completed paid transactions as gross revenue.
- Track actual platform/payment fees when available; otherwise label processor-fee numbers as estimates.
- Track other approved costs separately.
- Verified net cash = gross paid cash minus known fees/costs.
- Do not count leads, views, carts, checkouts, unpaid invoices, prospective contracts, hypothetical revenue, or paper-trading gains.
- Last known verified state: **$0 gross / $0 new spend / $0 verified net**, unless a connected execution session can verify otherwise.
...
- No unsolicited spam, stealth promotion, karma farming, or manufactured account eligibility.
- Real-money stock/crypto trading is not authorized. Market activity is research/paper-trading only.

## Live direct-sale CleanSheet offers
1. **CSV / Spreadsheet Cleanup & Data Formatting — $15**
   - Sales site: https://cleansheet-data.lovable.app
   - Checkout: https://book.stripe.com/cNi6oA4kj50YfZv4hY87K00
2. **Spreadsheet Formula Fix & Automation — $25**
   - Checkout: https://book.stripe.com/6oUeV6g319he3cJ3dU87K01
3. **PDF Table to Clean Spreadsheet Conversion — $20**
   - Checkout: https://book.stripe.com/3cI7sEcQP50Y28F15M87K02

Keep starter scope bounded. Do not make unsupported turnaround, accuracy, security, accounting, legal, tax, or compliance claims.

## Live ProjectScale / PostHogScale funnel
Repository: `NestWellInc/PostHogScale`

Current commercial ladder discovered/implemented in the repository:
- $15 Data Quality Audit
- $35 Cleanup + Normalization
- $49 Contractor Job-Cost CSV Normalization
...
- Fiverr launch kit / gallery production sheet / publication checklist / owner launch page
- organic distribution launch kit
- r/RemotePython owner post kit
- direct-sale distribution kit
- buyer-response-and-upsell kit
- `cash-ledger.csv`
- `lead-pipeline.csv`
...
Prepared first Gig concept:
- title: `I will clean format and organize your CSV or Excel spreadsheet`
- intended package ladder: approximately $15 Basic / $45 Standard / $95 reusable workflow, subject to current Fiverr category/package minimums and fields
- AI use: responsible customized AI/software-assisted work only, with meaningful review and freelancer accountability
...
- any CAPTCHA
- truthful personal profile facts
...
## Digital products already prepared in handoff packs
- Ecommerce Profit Tracker — target $7
- Inventory Reorder Calculator — target $7
...
`r/RemotePython` has repeatedly been preflighted as a candidate, with remote-tag and posting-frequency constraints. Always re-read live rules immediately before owner-authenticated posting. Do not assume historical acceptance guarantees current acceptance.

`r/forhire` has account-age/activity gates and explicitly forbids karma farming. Do not manufacture eligibility.
...
- data → reusable business workflow / batch processing system

Reject work requiring anti-detection tools, CAPTCHA bypass, unauthorized scraping, personal-data harvesting without clear authorization/licensing, hidden AI where prohibited, or qualifications we cannot truthfully claim.

## Software / API branch
A Vercel team connection was verified previously, but the software deployment path was not the immediate cash bottleneck. Prioritize storefront publication and distribution before spending scarce owner-attention on speculative API deployment unless the API is ready to ship with zero additional cost.

## Lovable / CleanSheet site status
A three-offer storefront draft was advanced previously, but a final correction/testing pass hit a free-credit wall. Do not buy credits without approval. If free editing access becomes available, recheck remaining legacy scope references and publish only after internal consistency QA.

## Market research branch
Paper-trading only. Maintain at least two families:
...
- CAPTCHAs
- binding attestations / legal acknowledgments
- truthful personal profile facts that cannot be inferred
- explicit approval before any new spend
